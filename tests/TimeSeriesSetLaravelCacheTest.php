...
use Apons\TimeSeriesSet\Adapters\LaravelCache\LaravelCacheSet;
use Apons\TimeSeriesSet\Adapters\LaravelCache\LaravelCacheSetStorage;
use Apons\TimeSeriesSet\Adapters\LaravelCache\LaravelCacheMock;

final class TimeSeriesSetLaravelCacheTest extends TestCase
{
    ...
    public function testSameTagInCurrentMinute()
    {
        $time = time();
        $tag='testtag';
        $timeSeriesSet=new TimeSeriesSet(new LaravelCacheSet(new LaravelCacheSetStorage(new LaravelCacheMock())));
        $timeSeriesSet->clear();
